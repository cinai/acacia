...
//import { faBorderNone, faFileInvoiceDollar, faChartArea } from '@fortawesome/free-solid-svg-icons'
import enaex  from '../../../logo-enaex.png';
import acacia  from '../../../logo-acacia.png';
...
const BarraLateral = props => {
    ...
    <div className="barra">
        <div id="logo-enaex">
          ...
          <p>Predicción de demanda de insumos y mediacamentos</p>
      </div>
      <div id="barra_lista">
        {/* <NavLink to="/Prediccion" activeClassName="selected">
          <div className="link-seccion">
            <FontAwesomeIcon icon={faChartArea} size="lg" />
            Predicción tronadura
          </div>
        </NavLink>
        <NavLink to="/Busqueda" activeClassName="selected">
          <div className="link-seccion">
            <FontAwesomeIcon icon={faBorderNone} size="lg" />
            Búsqueda de diseños factibles
          </div>
        </NavLink>
        <NavLink to="/Optimizacion" activeClassName="selected">
          <div className="link-seccion" >
