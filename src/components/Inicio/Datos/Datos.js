...
const rows = [
  createData('Datos 1', 'Demanda y stock 2018-2019','12/08/2019', '20%', '20%'),
  createData('Datos 2', 'Demanda y stock 2016-2019 actualizado','12/11/2019', '10%', '20%'),
  createData('Datos 3','Demanda y stock 2019','01/01/2020', '20%', '15%'),
];
