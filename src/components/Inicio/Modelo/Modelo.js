...
const rows = [
  createData('Modelo 1', 'Primera versión','Datos 1 (Demanda y stock 2018-2019)', '12/08/2019', 'OK', '82%'),
  createData('Modelo 2', 'Actualizado 2019' ,'Datos 3 (Demanda y stock 2019)', '06/01/2020', 'Entrenando', '-'),
];
